...
void OS::use_native_fonts() {
	...
	if (!found) {
		...
		use_any_font(OS_FONT, system_fonts, sizeof(system_fonts) / sizeof(char *));
	}
	// Use common monospace font
	const char *monospace_fonts[] = {"Consolas", "Lucida Console", "Courier New"};
	int monospace_i = use_any_font(FL_COURIER, monospace_fonts, sizeof(monospace_fonts) / sizeof(char *));
	...
	use_any_font(FL_COURIER_BOLD, bold_monospace_fonts, sizeof(bold_monospace_fonts) / sizeof(char *));
#else
	...
	use_any_font(FL_COURIER, monospace_fonts, sizeof(monospace_fonts) / sizeof(char *));
	// Use common bold monospace font
